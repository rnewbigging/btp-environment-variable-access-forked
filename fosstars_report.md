...
1.  [Suggest a security policy for the project](https://github.com/rnewbigging/btp-environment-variable-access-forked/security/policy)
...
Score: **2.5**, confidence is 9.47 (high), weight is 0.9 (high)
